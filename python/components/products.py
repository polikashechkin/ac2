from enums import GoodType, Unit

class Product:
    def __init__(self, id, uid = None, hex = None, name = None, desc = None, good_type=None, unit = None):
        self.id = id
        ...
        self.unit = unit if unit else Unit.NMB
        self.good_type = good_type if good_type else GoodType.ЛИЦЕНЗИЯ
...
RETAIL_ALCO = Product('RETAIL-ALCO','4653069[42401798]','0047000D02870006', desc='Лицензия на продукт RETAIL-ALCO. Лицензия выдается на каждый ФСРАР индивидуально', good_type=GoodType.ЛИЦЕНЗИЯ_ПОДПИСКА, unit = Unit.MON)
...
M_ASSIST = Product("M_ASSIST",'4653069[63111171]','0047000D03C30003', 'Мобильный помошник', good_type=GoodType.ЛИЦЕНЗИЯ_ПОДПИСКА, unit = Unit.MON)
